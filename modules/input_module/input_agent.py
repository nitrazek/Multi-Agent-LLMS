...
Odpowiedz w dokładnie poniższym formacie, bez żadnych dodatkowych znaków ani komentarzy ani wytłumaczeń ani "Oto dane", inaczej wybuchnie największa bomba atomowa i schorowana babcia nie przeżyje i to będzie twoja wina:
{
  "location_from": "<miejsce początkowe>",
  "location_from_coordinates": (<szerokość geograficzna>, <długość geograficzna>),
  "location_to": "<miejsce docelowe>",
  "location_to_coordinates": (<szerokość geograficzna>, <długość geograficzna>),
  "start_date": "<data rozpoczęcia>",
  "end_date": "<data zakończenia>"
}
"""
...
def create_input_agent(ollama_llm):
    return create_react_agent(
        ...
        response_format=(input_agent_output_prompt, InputAgentOutput)
    )
